  ...
  <view class="mct">
    ...
    <view class="content">
      ...
      <view v-if="current == '1'" class="topic">
        <view v-for="item in topic" :key="item.id" @click="toInfo(item.text)" class="topic_item">
...
import { outline_top, grade_standard, task_outline, vocabulary_outline } from '@/common/request.js'
...
export default {
  ...
  data() {
    return {
      ...
      topic: [
        {
          img: '/pageCity/static/images/ddoctor.jpg',
          text: '医生-医生',
        },
        {
          img: '/pageCity/static/images/dpatient.jpg',
          text: '医生-患者',
        },
        {
          img: '/pageCity/static/images/dnurse.jpg',
          text: '医生-护士',
        },
        {
          img: '/pageCity/static/images/pnurse.jpg',
          text: '患者-护士',
        },
      ],
    }
  ...
  methods: {
    ...
    toInfo(e) {
      uni.navigateTo({
        url: '/page_study/topicInfo/index?id=' + e,
      })
    },
    changePage(e) {
      this.page = e.current
