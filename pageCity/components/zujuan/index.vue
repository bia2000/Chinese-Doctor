  ...
  <view class="zujuan">
   <view class="dropdown">
      ...
      <dropDown
        ...
        placeholder="组卷次数"
      ></dropDown>
      <view class="guide" @click="$goBack(2, '/pages/pratice/paperGuide/index')">
        试卷结构指引
      </view>
    </view>
    <view class="dropdown">
        ...
        <view class="detail-info">
          ...
          <view class="" v-if="current == 1">
            <view class="" v-if="isAlive">
              <echarts class="echarts" :option="option3" v-if="isAlive"></echarts>
							<view class="" v-if="isAlive">
							  <echarts class="echarts" :option="option2" v-if="isAlive"></echarts>
							</view>
							<view class="" v-if="isAlive">
							  <echarts class="echarts" :option="option1" v-if="isAlive"></echarts>
							</view>
              <view class="sum">
                <view class="total">
...
import dropDown from 'pageCity/components/dropDown'
...
export default {
  ...
  methods: {
    ...
    toCompose() {
      ...
      setTimeout(() => {
        uni.navigateTo({
          url: '/pages/pratice/zujuanDetail/index?list=' + this.question_set,
        })
      }, 1000)
    },
    change(index) {
    ...
    getFile(url) {
      return 'https://cloud-minapp-44018.cloud.ifanrusercontent.com/' + url
    },
    reloadAll() {
      this.isAlive = false
      this.$nextTick(() => {
